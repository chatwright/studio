  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing:border-box; } html { scroll-behavior:smooth; } body { margin:0; color:var(--ink); background:var(--canvas); } a { color:inherit; }
      ...
      .graph-line { display:inline-flex; flex-wrap:wrap; align-items:center; gap:.4rem; margin:1.1rem 0 0; padding:.7rem .9rem; border:1px solid var(--line); border-radius:.5rem; background:var(--card); color:var(--ink); font:650 .9rem/1.5 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace; }
      ...
      .recipe-card { padding:1.4rem 1.5rem 1.6rem; border:1px solid var(--line); border-radius:.75rem; background:var(--card); scroll-margin-top:5.5rem; }
      ...
      .recipe-jobs { margin:.4rem 0 0; color:var(--soft); font-size:.85rem; } .recipe-jobs a { color:var(--accent-ink); font-weight:600; text-decoration:underline; text-decoration-color:rgba(13,148,136,.3); text-underline-offset:.15em; }
      ...
      .chip { padding:.22rem .58rem; border:1px solid var(--line); border-radius:999px; color:var(--soft); background:var(--card-soft); font-size:.74rem; font-weight:600; }
      ...
      .button-mini { display:inline-block; padding:.42rem .85rem; border-radius:8px; background:var(--accent,#0f766e); color:#fff; font-weight:700; font-size:.8rem; text-decoration:none; }
      .button-mini-live { background:var(--card); color:var(--blue); border:1px solid #b7cdf2; }
      .card-actions-note { color:var(--faint); font-size:.76rem; }
      .chip-specfirst { color:var(--accent-tint-ink); background:var(--accent-tint-bg); border-color:var(--accent-tint-border); }
      .impl-list { list-style:none; margin:1rem 0 0; padding:0; display:grid; gap:.5rem; }
      .impl-row { display:flex; flex-wrap:wrap; align-items:center; gap:.55rem; padding:.55rem .7rem; border:1px solid var(--line); border-radius:.5rem; background:var(--card-soft); font-size:.86rem; }
      ...
      .snippet-row-label { color:var(--faint); font:700 .68rem/1.2 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace; letter-spacing:.08em; text-transform:uppercase; }
      .card-link { display:inline-block; margin:1.15rem 0 0; color:var(--accent-ink); font-weight:650; font-size:.87rem; text-decoration:underline; text-decoration-color:rgba(13,148,136,.3); text-underline-offset:.15em; }
      .card-link:hover { text-decoration-color:currentColor; }
      .jobs-list { list-style:none; margin:0; padding:0; display:grid; gap:.6rem; }
      .job-row { display:flex; flex-wrap:wrap; align-items:center; justify-content:space-between; gap:.75rem; padding:.85rem 1rem; border:1px solid var(--line); border-radius:.6rem; background:var(--card); scroll-margin-top:5.5rem; }
      .job-title { font-weight:640; }
      .job-solved a { color:var(--accent-ink); font-weight:650; font-size:.87rem; text-decoration:none; } .job-solved a:hover { text-decoration:underline; }
      ...
      .registry-row { display:flex; flex-wrap:wrap; align-items:center; justify-content:space-between; gap:.75rem; padding:.85rem 1rem; border:1px solid var(--line); border-radius:.6rem; background:var(--card); }
      .registry-repo { display:flex; flex-wrap:wrap; align-items:center; gap:.55rem; font-weight:640; }
      .registry-repo a { color:var(--accent-ink); text-decoration:underline; text-decoration-color:rgba(13,148,136,.3); text-underline-offset:.15em; }
      ...
      .foot-note code { padding:.05rem .32rem; border-radius:.3rem; background:var(--code-bg); color:var(--accent-ink); font-size:.72rem; }
