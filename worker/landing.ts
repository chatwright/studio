...
<html lang="en">
  <head>
    ...
    ${themeInitScript}
    <meta name="description" content="Chatwright is an open, executable knowledge platform for conversational UX — recipes with live demos, capability tables generated from data, and tests that produce replayable evidence. Telegram first; WhatsApp in preview.">
    <title>Chatwright — Learn, design, test and compare conversational UX</title>
    ...
    <meta property="og:title" content="Chatwright — Learn, design, test and compare conversational UX">
    <meta property="og:description" content="An open, executable knowledge platform for conversational UX — recipes with live demos, capability tables generated from data, and tests that produce replayable evidence.">
    <meta property="og:url" content="https://chatwright.dev/">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Chatwright — Learn, design, test and compare conversational UX">
    <meta name="twitter:description" content="An open, executable knowledge platform for conversational UX — recipes with live demos, capability tables generated from data, and tests that produce replayable evidence.">
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"SoftwareApplication","name":"Chatwright","description":"Chatwright is an open, executable knowledge platform for conversational UX — recipes with live demos, capability tables generated from data, and tests that produce replayable evidence, across messaging platforms starting with Telegram.","applicationCategory":"DeveloperApplication","operatingSystem":"macOS, Linux, Windows","url":"https://chatwright.dev/","codeRepository":"https://github.com/chatwright/chatwright","license":"https://www.apache.org/licenses/LICENSE-2.0","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"},"publisher":{"@type":"Organization","name":"Sneat.co","url":"https://sneat.co"}}</script>
    <style>
      ...
      * { box-sizing:border-box; } html { scroll-behavior:smooth; } body { margin:0; color:var(--ink); background:var(--canvas); } a { color:inherit; }
      ...
      .hero { display:grid; grid-template-columns:minmax(19rem,.82fr) minmax(32rem,1.18fr); align-items:center; gap:clamp(2.5rem,6vw,5.6rem); padding:clamp(2.75rem,6vw,7.5rem) 0 clamp(5.5rem,10vw,9rem); } .hero-intro { text-align:left; } .eyebrow { margin:0 0 1rem; color:var(--blue); font:700 .7rem/1.2 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace; letter-spacing:.12em; text-transform:uppercase; }
      h1 { max-width:20ch; margin:0; font-weight:700; font-size:clamp(2.35rem,3.6vw,3.5rem); line-height:1.08; letter-spacing:-.015em; word-spacing:normal; } .hero-copy { max-width:32rem; margin:1.4rem 0 0; color:var(--soft); font-size:clamp(1.02rem,1.35vw,1.17rem); line-height:1.6; }
      .actions { display:flex; justify-content:flex-start; flex-wrap:wrap; gap:.7rem; margin-top:1.75rem; } .proof { display:flex; justify-content:flex-start; flex-wrap:wrap; align-items:center; gap:.55rem 1rem; margin:1.25rem 0 0; color:var(--faint); font-size:.76rem; } .proof span::before { content:""; display:inline-block; width:.38rem; height:.38rem; margin:0 .36rem .06rem 0; border-radius:50%; background:var(--accent-ink); } .proof .offline { padding:.36rem .56rem; border:1px solid var(--accent-tint-border); border-radius:.42rem; color:var(--accent-tint-ink); background:var(--accent-tint-bg); font-weight:800; box-shadow:0 5px 14px rgba(15,118,110,.13); } .proof .offline::before { margin-bottom:.03rem; }
      .terminal-card { max-width:29rem; margin:1.65rem 0 0; overflow:hidden; border-radius:.65rem; } .terminal-titlebar { display:flex; align-items:center; gap:.42rem; padding:.5rem .7rem; background:#172231; border-bottom:1px solid rgba(228,236,245,.13); } .terminal-dot { width:11px; height:11px; border-radius:50%; } .terminal-dot-red { background:#ff5f57; } .terminal-dot-yellow { background:#febc2e; } .terminal-dot-green { background:#28c840; } .terminal-title { flex:1 1 auto; margin-right:2.1rem; text-align:center; color:#8290a4; font:650 .64rem/1 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace; letter-spacing:.08em; text-transform:uppercase; } .terminal-card pre.hero-terminal { margin:0; border-radius:0; }
      .hero-preview { min-width:0; } .preview-head { display:flex; align-items:end; justify-content:space-between; gap:1rem; margin:0 0 .85rem; } .preview-head h2 { margin:0; font-size:1rem; letter-spacing:-.025em; } .preview-head p { margin:.25rem 0 0; color:var(--soft); font-size:.83rem; } .preview-head a { color:var(--accent-ink); font-size:.8rem; font-weight:700; text-decoration:none; }
      .browser { overflow:hidden; border:1px solid var(--line); border-radius:1rem; background:#101925; box-shadow:0 28px 70px rgba(29,43,60,.14); } .browser-bar { min-height:3.25rem; display:grid; grid-template-columns:minmax(0,1fr) auto; align-items:center; gap:.75rem; padding:.55rem .7rem .55rem 1rem; border-bottom:1px solid rgba(228,236,245,.13); background:#172231; }
      .address { min-width:0; overflow:hidden; padding:.48rem .7rem; border:1px solid rgba(228,236,245,.12); border-radius:.42rem; color:#d9e3ef; background:#101925; font:500 .69rem/1.1 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace; text-decoration:none; text-overflow:ellipsis; white-space:nowrap; } .address:hover { color:#fff; border-color:rgba(94,234,212,.55); }
      ...
      .cli { padding:clamp(2.2rem,5vw,4rem); border:1px solid var(--line); border-radius:.9rem; background:var(--card-soft); } .cli > p { margin:0 0 .65rem; color:var(--blue); font:700 .68rem/1.2 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace; letter-spacing:.11em; text-transform:uppercase; } .cli h2 { max-width:640px; margin:0; font-size:clamp(1.8rem,3vw,2.75rem); line-height:1.04; letter-spacing:-.055em; } pre { overflow:auto; margin:1.7rem 0 0; padding:1.1rem 1.2rem; border-radius:.65rem; color:#d5e4ef; background:#101925; font:500 .76rem/1.8 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace; tab-size:2; } pre b { color:#5eead4; font-weight:inherit; } .callout { margin:1.4rem 0 0; color:var(--accent-ink); font:650 .85rem/1.55 inherit; } .callout a { text-decoration:none; } .cli + .cli { margin-top:2rem; }
      #status .step { grid-template-columns:5.6rem 1fr; } #status .step > span { letter-spacing:.03em; } #status .step > span.done { color:var(--accent-ink); }
      ...
      .hero-files { display:flex; flex-wrap:wrap; gap:.55rem; margin:1.1rem 0 0; } .file-chip { flex:1 1 auto; min-width:9rem; display:flex; align-items:center; gap:.55rem; padding:.5rem .7rem; border:1px solid var(--line); border-radius:.6rem; background:var(--card); cursor:grab; font:inherit; text-align:left; transition:border-color .15s ease,box-shadow .15s ease,transform .15s ease; } .file-chip:hover { border-color:var(--blue); box-shadow:0 6px 16px rgba(44,109,204,.14); transform:translateY(-1px); } .file-chip:active { cursor:grabbing; } .file-chip.active { border-color:var(--accent-ink); background:var(--accent-tint-bg); }
      ...
      .hero-files-note { margin:.75rem 0 0; color:var(--soft); font-size:.78rem; } .hero-files-note code { padding:.05rem .32rem; border-radius:.3rem; background:var(--code-bg); color:var(--accent-ink); font-size:.74rem; }
...
<b>ok</b>  chatwright.dev/runtime  0.315s</pre></div><div class="actions fade delay"><a class="button primary" href="/studio/playground">Try it in the browser</a><a class="button quiet" href="https://github.com/chatwright/chatwright">View on GitHub</a></div><p class="proof"><span class="offline">Works offline</span><span>Open-source CLI · Apache-2.0</span><span>Telegram: text, actions, edits</span><span>WhatsApp: text (preview)</span></p></div><section id="player" class="hero-preview" aria-label="The Chatwright player, live"><div class="preview-head"><div><h2>The player, live</h2><p>The real Chatwright player, preloaded with a sample run bundle—not a recording.</p></div><a href="/studio/player">Open in a full tab →</a></div><div class="browser"><div class="browser-bar"><a class="address" href="/studio/player" target="_blank" rel="noopener" aria-label="Open the Chatwright player in a new tab">https://chatwright.dev/studio/player</a><span class="sample">Sample run bundle</span></div><iframe id="hero-player" data-src="/studio/player?embed=1&amp;autoplay=1&amp;sample=greetbot-two-part.chatwright.json" title="Chatwright player, preloaded with a sample run bundle" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe><noscript><iframe src="/studio/player?embed=1&amp;sample=greetbot-two-part.chatwright.json" title="Chatwright player, preloaded with a sample run bundle" loading="lazy"></iframe></noscript></div><div class="hero-files" role="group" aria-label="Sample run bundles — click to load one, or drag your own from your computer onto the player"><button type="button" class="file-chip active" draggable="true" data-sample="greetbot-two-part.chatwright.json"><span class="file-chip-icon" aria-hidden="true"></span><span class="file-chip-body"><span class="file-chip-title">Greetbot — two parts</span><span class="file-chip-name mono">greetbot-two-part.chatwright.json</span></span></button><button type="button" class="file-chip" draggable="true" data-sample="greetbot-three-part.chatwright.json"><span class="file-chip-icon" aria-hidden="true"></span><span class="file-chip-body"><span class="file-chip-title">Greetbot — three parts</span><span class="file-chip-name mono">greetbot-three-part.chatwright.json</span></span></button><button type="button" class="file-chip" draggable="true" data-sample="debt-two-chat.chatwright.json"><span class="file-chip-icon" aria-hidden="true"></span><span class="file-chip-body"><span class="file-chip-title">Debt — two chats, three actors</span><span class="file-chip-name mono">debt-two-chat.chatwright.json</span></span></button></div><p class="hero-files-note">Click a sample to load it above—or drag your own <code>*.chatwright.json</code> run bundle onto the player.</p></section></section>
      ...
      <section id="bots" class="cli wrap" aria-label="The bot protocol"><p>The bot protocol</p><h2>Your bot is a black box. That’s the point.</h2><div class="why-copy"><p>Platform-native payloads, always: a Telegram bot receives real Telegram Bot API updates and answers with real Bot API calls. There is no Chatwright bot API to learn.</p><div class="steps"><article class="step"><span>01</span><div><strong>In-browser bot</strong><p>Loaded from a URL into an iframe; the runtime speaks to it with postMessage. JavaScript, TypeScript, WASM, AI — anything that can answer platform payloads.</p></div></article><article class="step"><span>02</span><div><strong>Remote bot</strong><p>Point your bot’s API root at Chatwright over HTTPS — webhooks and polling work like the real platform. Existing frameworks connect unmodified.</p></div></article></div><div class="callout"><a href="/formats/chatwright-md/v1">Connect your own bot →</a></div></div></section>
...
whatsapp   text (experimental)</pre></section>
      <section class="cli wrap"><p>Testing &amp; recording</p><h2>Replay it. Regress it. Prove it.</h2><div class="why-copy"><p>Testing is first-class: replay, regression, golden conversations, assertions with timing. Recording is effectively free — transcript, event trace, every bot request and response — because the runtime routes everything anyway. Download a run bundle with no account; replay it in the player; save to Chatwright Cloud when you sign in (later).</p></div><p class="callout"><a href="/quickstart">Run a scenario document with the CLI →</a></p></section>
      <section class="cli wrap"><p>Community</p><h2>Independent metrics. No opaque score.</h2><div class="why-copy"><p>Appreciation is designed in: GitHub stars, per-scenario leaderboards, adoption rankings, author profiles — independent metrics, never one opaque score. Today: star the repos, add the badge to your README, register your repository in the index.</p></div><pre>[![Try in Chatwright](https://chatwright.dev/badge.svg)](https://chatwright.dev/try/github/OWNER/REPO)</pre></section>
      <section id="status" class="cli wrap" aria-label="Status and roadmap"><p>Status &amp; roadmap</p><h2>Deterministic evidence first—everything else builds on it.</h2><div class="steps"><article class="step"><span class="done">✅</span><div><strong>Deterministic Telegram testing</strong><p>Text, inline actions and in-place edits, driven over real HTTP webhooks—today.</p></div></article><article class="step"><span class="done">✅</span><div><strong>Run bundles &amp; the player</strong><p>Record a run, drag the file into the browser, replay every interaction.</p></div></article><article class="step"><span>NEXT</span><div><strong>Browser runtime &amp; live recipe demos</strong><p>The orchestrator behind the Playground—scaffolded at chatwright/runtime-ts; recipes go live in the page when it lands.</p></div></article><article class="step"><span>NEXT</span><div><strong>Recipes index</strong><p>First jobs, recipes and capability data are live at github.com/chatwright/recipes.</p></div></article><article class="step"><span class="done">✅</span><div><strong>Scenario documents</strong><p>One self-contained JSON file declares a bot, an AI goal and its checks — <code>chatwright run</code> executes it, no Go and no manifest. CLI/Go runtime today; browser runtime support is in progress.</p></div></article><article class="step"><span>PHASE 2</span><div><strong>AI actors &amp; the model arena</strong><p>Goal-driven AI personas, benchmark leaderboards; deterministic assertions stay authoritative.</p></div></article></div></section>
    </main>
    ${renderFooter()}
    <script>
        ...
        for (var j = 0; j < chips.length; j++) {
          (function (chip) {
            chip.addEventListener('click', function () {
              ...
              if (!sample) { return; }
              var src = '/studio/player?embed=1&autoplay=1&sample=' + encodeURIComponent(sample);
