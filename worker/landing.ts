...
<html lang="en">
  ...
  <body>
    <header class="nav"><div class="wrap"><a class="brand" href="/" aria-label="Chatwright home">Chatwright <small>by sneat.dev</small></a><nav class="links" aria-label="Primary navigation"><a href="#playground">Playground</a><a href="#how-it-works">How it works</a><a href="#status">Status</a><a href="https://github.com/chatwright/chatwright">GitHub</a></nav><a class="button primary" href="/studio/">Open Studio</a></div></header>
    <main>
      <section class="hero wrap"><div class="hero-intro"><p class="eyebrow fade">Telegram Bot API emulator · local, deterministic testing</p><h1 class="fade">The platform is emulated.<br>Your bot is real.</h1><p class="hero-copy fade delay">Chatwright emulates the Telegram Bot API on your machine—not automation of someone’s Telegram client. Your bot answers real webhooks; every API call it makes becomes an assertion, with timing, not a guess.</p><pre class="hero-terminal fade delay"><b>$</b> go get github.com/chatwright/chatwright
<b>$</b> go test ./... -run TestGreeting
<b>ok</b>  github.com/chatwright/chatwright  0.315s</pre><div class="actions fade delay"><a class="button primary" href="#playground">Try the Playground preview</a><a class="button quiet" href="https://github.com/chatwright/chatwright">View on GitHub</a></div><p class="proof"><span class="offline">Works offline</span><span>Open-source CLI · Apache-2.0</span><span>Telegram: text, actions, edits</span><span>WhatsApp: text (preview)</span></p></div><section id="playground" class="hero-preview" aria-label="Interactive Studio preview"><div class="preview-head"><div><h2>Studio Playground preview</h2><p>An interactive preview of Chatwright Studio, running on sample data—not a live bot.</p></div><a href="/studio/">Open in a full tab →</a></div><div class="browser"><div class="browser-bar"><a class="address" href="/studio/" target="_blank" rel="noopener" aria-label="Open Chatwright Studio in a new tab">https://chatwright.dev/studio/</a><span class="sample">Sample data</span></div><iframe src="/studio/emulator" title="Chatwright Studio Playground preview, running on sample data" loading="lazy"></iframe></div></section></section>
...
msg.<b>ExpectEdited</b>().
	...
	Text("¡Hola, forastero!")</pre><p class="callout">Your bot can be in any language—Chatwright only speaks HTTP.</p></section>
      <section class="cli wrap"><p>Install the CLI</p><h2>Small, dependency-light, and honest about what it does today.</h2><pre><b>$</b> go install github.com/chatwright/chatwright/cmd/chatwright@latest
