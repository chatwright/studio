  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing:border-box; } html { scroll-behavior:smooth; } body { margin:0; color:var(--ink); background:var(--canvas); } a { color:inherit; }
      ...
      .links-compact { display:none; align-items:center; gap:.2rem; color:#4e5c70; } .icon-link { display:inline-flex; align-items:center; justify-content:center; width:40px; height:40px; border-radius:.55rem; color:#4e5c70; text-decoration:none; } .icon-link:hover { color:var(--ink); background:#f2f5f8; } .icon-emoji { font-size:1.05rem; line-height:1; } .icon-svg svg { display:block; width:18px; height:18px; }
      ...
      footer { padding:2.5rem 0 3rem; color:#718094; font-size:.78rem; } footer .wrap { display:flex; justify-content:space-between; gap:1rem; border-top:1px solid var(--line); padding-top:1.45rem; } footer a { color:var(--soft); text-decoration:none; } .foot-links { display:flex; flex-wrap:wrap; align-items:center; gap:.55rem 1.1rem; }
      ...
      @media (max-width:720px) { .wrap { width:min(100% - 2rem,1180px); } .nav > .wrap { min-height:64px; } .links { display:none; } .links-compact { display:flex; } .nav > .wrap > .button.primary { display:none; } .brand small { display:none; } .hero { padding-top:4.6rem; } h1 { font-size:clamp(2.85rem,14vw,4.2rem); } .preview-head { align-items:start; flex-direction:column; } iframe { height:560px; min-height:0; } .why { grid-template-columns:1fr; } .why h2 { max-width:11ch; } footer .wrap { align-items:flex-start; flex-direction:column; } }
    </style>
  </head>
  <body>
    <header class="nav"><div class="wrap"><a class="brand" href="/" aria-label="Chatwright home">Chatwright <small>by sneat.dev</small></a><nav class="links" aria-label="Primary navigation"><a href="/studio/player">Player</a><a href="/studio/playground">Playground</a><a href="/recipes">Recipes</a><a href="/pricing">Pricing</a><a href="https://github.com/chatwright/chatwright">GitHub</a></nav><nav class="links-compact" aria-label="Primary navigation"><a class="icon-link" href="/studio/player" aria-label="Player" title="Player"><span class="icon-emoji" aria-hidden="true">▶</span><span class="visually-hidden">Player</span></a><a class="icon-link" href="/studio/playground" aria-label="Playground" title="Playground"><span class="icon-emoji" aria-hidden="true">⚡</span><span class="visually-hidden">Playground</span></a><a class="icon-link" href="/recipes" aria-label="Recipes" title="Recipes"><span class="icon-emoji" aria-hidden="true">🍳</span><span class="visually-hidden">Recipes</span></a><a class="icon-link" href="/pricing" aria-label="Pricing" title="Pricing"><span class="icon-emoji" aria-hidden="true">🏷️</span><span class="visually-hidden">Pricing</span></a><a class="icon-link icon-svg" href="https://github.com/chatwright/chatwright" aria-label="GitHub" title="GitHub"><span aria-hidden="true"><svg viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8Z"></path></svg></span><span class="visually-hidden">GitHub</span></a><a class="icon-link icon-cta" href="/studio/" aria-label="Open Studio" title="Open Studio"><span class="icon-emoji" aria-hidden="true">🎛️</span><span class="visually-hidden">Open Studio</span></a></nav><a class="button primary" href="/studio/">Studio</a></div></header>
    <main>
...
whatsapp   text (experimental)</pre></section>
    ...
    <footer><div class="wrap"><span>An independent open-source project by Sneat.co</span><nav class="foot-links" aria-label="Footer"><a href="/pricing">Pricing</a><a href="https://github.com/chatwright/recipes">chatwright/recipes</a><a href="https://github.com/chatwright/runtime-ts">chatwright/runtime-ts</a><a href="https://specscore.md/">Developed spec-first with SpecScore</a><a href="https://sneat.dev/">Explore sneat.dev →</a></nav></div></footer>
    <script>
