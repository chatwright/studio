  ...
  },
  {
    ...
    "replyTo": "note-1"
        ...
        <ul class="convlist">
          ...
          <li><strong>Enums are string constants</strong><span>Direction, journal-entry kind, freshness, actor, change kind, proposal kind and action-outcome kind are all human-readable strings (<code>"user"</code>, <code>"message"</code>, <code>"fresh"</code>, …) — never a bare integer.</span></li>
